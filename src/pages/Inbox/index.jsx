      ...
      <li className="flex py-6">
        ...
        <div className="ml-4 flex flex-1 flex-col">
          ...
          <div className="flex flex-1 items-end justify-between text-sm">
            ...
            <div className="flex">
              <span className="inline-block py-1.5 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded-full">
                1
              </span>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="relative flex h-16 items-center justify-between">
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    <Link
                      to="#"
                      className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-1 rounded-md text-sm font-medium border-dashed border-2 border-gray-700"
                    >
                      Unread
                    </Link>
                  </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6">
                <button
                  type="button"
                  className="rounded-full bg-gray-800 p-1 px-2 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
        ...
        <div className="mb-0">
          <div className="p-10 border-b border-gray-200 dark:border-gray-600 text-center">
            ...
            <div className="m-auto">
              <button
                type="button"
                className="rounded-full bg-gray-700 p-2 mx-5 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
              >
          ...
          <button
            type="button"
            className="p-2 mb-5 text-violet-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
          >
            + add a property
          </button>
          <div className="mb-2 sm:mb-0">
            <div className="relative flex ">
              <textarea
                ...
                name="about"
                rows="3"
                className="p-5 bg-gray-800 mt-1 block w-full rounded-md border border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              ...
              <div className="absolute left-0 bottom-0 items-center hidden sm:flex">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="w-6 ml-2 transform rotate-90"
                  >
